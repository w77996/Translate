 ...
 */
@Entity
public class DevRecorderBean implements Parcelable{
    @Property
    ...
    protected DevRecorderBean(Parcel in) {
    ...
    @Generated(hash = 1977212380)
    public DevRecorderBean(String language_type, int type, String mRecorderTxt,
    ...
    @Generated(hash = 713696293)
    public DevRecorderBean() {
    }
    ...
    public static final Creator<DevRecorderBean> CREATOR = new Creator<DevRecorderBean>() {
        @Override
        public DevRecorderBean createFromParcel(Parcel in) {
            return new DevRecorderBean(in);
        }

        @Override
        public DevRecorderBean[] newArray(int size) {
            return new DevRecorderBean[size];
        }
    };
    ...
    public static Creator<DevRecorderBean> getCREATOR() {
        return CREATOR;
    }
}
