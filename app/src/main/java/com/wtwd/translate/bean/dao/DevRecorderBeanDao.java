...
/** 
 * DAO for table "DEV_RECORDER_BEAN".
*/
public class DevRecorderBeanDao extends AbstractDao<DevRecorderBean, Void> {

    public static final String TABLENAME = "DEV_RECORDER_BEAN";

    /**
     * Properties of entity DevRecorderBean.<br/>
    ...
    public DevRecorderBeanDao(DaoConfig config) {
        super(config);
    }
    
    public DevRecorderBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DEV_RECORDER_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DEV_RECORDER_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DevRecorderBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DevRecorderBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public DevRecorderBean readEntity(Cursor cursor, int offset) {
        DevRecorderBean entity = new DevRecorderBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, DevRecorderBean entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(DevRecorderBean entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(DevRecorderBean entity) {
        return null;
    }

    @Override
    public boolean hasKey(DevRecorderBean entity) {
        // TODO
        return false;
    }
