 ...
 * Created by w77996
 */
public class BTOpenDialog extends Dialog implements View.OnClickListener{

    private Context context;      // 上下文
    private int layoutResID;      // 布局文件id
    private int[] listenedItems;  // 要监听的控件id

    public BTOpenDialog(Context context, int layoutResID, int[] listenedItems) {
    ...
    public interface OnCenterItemClickListener {
        void OnCenterItemClick(BTOpenDialog dialog, View view);
    }
